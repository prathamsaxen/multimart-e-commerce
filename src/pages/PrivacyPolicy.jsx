...
function PrivacyPolicy() {
  return (
    <div className="container privacy">
      ...
      <p className="yellow">
        <span>[NOTE TO MERCHANT: </span>
        <span>
          This is a template Privacy Policy designed to cover your collection,
          use, and disclosure of personal information about visitors and
          customers of your Shopify-powered Site. Please review and customize
          the content so that it is tailored to your store and business
          practices regarding how you collect, use, and disclose personal data.
          For example, you may need to update the template content if: you are
          based in certain jurisdictions (particularly to reflect certain
          disclosures that are required under GDPR), you collect information
          from other sources like third parties or offline; you disclose
          information to additional service providers or business partners; or
          you add third-party cookies or other analytics tools.{" "}
          <u>
      ...
      <p>
        ...
        0cafad.myshopify.com (the "<strong>Site</strong>") or otherwise
        communicate with us (collectively, the "<strong>Services</strong>"). For
        purposes of this Privacy Policy, "<strong>you</strong>" and "
      ...
      <ul>
        ...
        <li>
          ...
          address, shipping address, payment confirmation, email address, phone
          number.
        </li>
        <li>
      ...
      <p>
        ...
        with the Services ("<strong>Usage Data</strong>"). To do this, we may
        use cookies, pixels and similar technologies ("<strong>Cookies</strong>
      ...
      <ul>
        ...
        <li>
          ...
          account credentials safe. We highly recommend that you do not share
          your username, password, or other access details with anyone else. If
      ...
      <ul>
        ...
        <li>
          ...
          <span className="yellow">
            [NOTE TO MERCHANT: INSERT THE FOLLOWING SENTENCE IF USING SHOPIFY’S
            AD SERVICES, SUCH AS SHOPIFY AUDIENCES] [For example, we use Shopify
            to support personalized advertising with third-party services].
          </span>{" "}
      ...
      <table className="yellow">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <span>Business and marketing partners</span>
            </td>
          </tr>
          <tr>
            <td>
      ...
      <ul>
        <li>
          ...
          including details relating to the ways in which we use and share your
          information.
        </li>
        <li>
          <strong>Right to Delete.</strong> You may have a right to request that
          we delete personal information we maintain about you.
        </li>
        <li>
        ...
        <li>
          <strong>Right of Portability.</strong> You may have a right to receive
          a copy of the personal information we hold about you and to request
          that we transfer it to a third party, in certain circumstances and
      ...
      <p>
        <span className="yellow">
          ...
          ON YOUR SITE BY USING <u>SHOPIFY'S PRIVACY AND COMPLIANCE APP</u> OR
          OTHERWISE.]
        </span>
      </p>
      <ul className="yellow">
      ...
      <ul>
        ...
        <li>
          ...
          ask us to stop or restrict our processing of personal information.
        </li>
        <li>
          <strong>Withdrawal of Consent:</strong> Where we rely on consent to
          process your personal information, you may have the right to withdraw
          this consent.
        </li>
        <li>
        ...
        <li>
          ...
          promotional emails, and you may opt out of receiving these at any time
          by using the unsubscribe option displayed in our emails to you. If you
          opt out, we may still send you non-promotional emails, such as those
      ...
      <p>
        ...
        recognized transfer mechanisms like the European Commission's Standard
        Contractual Clauses, or any equivalent contracts issued by the relevant
        competent authority of the UK, as relevant, unless the data transfer is
        to a country that has been determined to provide an adequate level of
        protection.
      </p>
      ...
      <p>
        ...
        or email us at info.kraftvision@gmail.com or contact us at Jaintipur
        Road Shiv Nagar, 244001 Moradabad UP, India.
      </p>
      <p>
        <span className="yellow">
